    ...
    public class MainDatabase : DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Server>().HasData(
                ...
                new Server { ServerId = 3, Name = "Maiden", Image = "server_3.png", AdminId = 2 },
            ...
            modelBuilder.Entity<InstantInvite>().HasData(
                new InstantInvite { Link = "1", ServerId = 1, NerverExpire = true },
                new InstantInvite { Link = "2", ServerId = 2, NerverExpire = true },
